  ...
  <body>
		...
		<div id="login-page">
	  	<div class="container">
			...
			<form action="{{ action('PasswordController@postChangePassword') }}" method="POST">
			    <h2 class="form-login-heading">Reset Password</h2>
		        <div class="login-wrap">
		        	<div class="control">
                        <input type="password" class="form-control" placeholder="Last Password" name="last_password">
                        {{ $errors->first('last_password') }}
                    </div>
                    <br>
		            <div class="control">
